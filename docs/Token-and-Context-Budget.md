...
|---|---|---|
| Active context | Level 0 ≤400 approximate tokens; worst-case operational core ≤3,000; `SOUL.md` ≤900 words; ≤15 categories; ≤20 skills/category; registry descriptions target ≤350 characters | Level 0 394; operational core 2,993; `SOUL.md` 205 words; 11 categories; largest category 4 skills |
...
skills/core/evidence-first-operating-style/SKILL.md 1,345
                                                     -----
Operational core                                  2,993 / 3,000
```

The four other core skills are trigger-loaded and reported separately, not silently added to startup. Their current combined estimate is 3,018 approximate tokens.
