...
# Simulation Lab Pack Declaration
...
- **Expected review cost:** two bounded sessions for sandbox authority, resolution scoring, false-realism, storage, and promotion-boundary review
- **Seed-content source requirement:** a real resolved simulation with assumptions, source rows, falsifier, outcome, scoring rule, and explicit separation from live execution
- **Kill condition:** remain inert or retire if speculative outputs lose labels, resolution evidence stays absent, live actions consume simulations as facts, or review surface exceeds learning
